...
public final class OrderStatusEncoder
{
    ...
    public OrderStatusEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderStatusEncoder orderStatusConcrete(final OrderStatusConcrete value)
    {
    ...
    public OrderStatusEncoder errorCode(final ErrorCode value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrderStatusDecoder decoder = new OrderStatusDecoder();
