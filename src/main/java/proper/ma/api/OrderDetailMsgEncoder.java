...
public final class OrderDetailMsgEncoder
{
    ...
    private final OrderDetailMsgEncoder parentMessage = this;
    ...
    public OrderDetailMsgEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderDetailMsgEncoder wrapAndApplyHeader(
    ...
    {
        orderDetail.wrap(buffer, offset + 0);
        return orderDetail;
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrderDetailMsgDecoder decoder = new OrderDetailMsgDecoder();
